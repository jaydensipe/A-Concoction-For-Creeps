...
func _clear() -> void:
	...
	(button.get_surface_override_material(0) as StandardMaterial3D).emission_texture = (STONE_WAITING as StandardMaterial3D).emission_texture
	(button.get_surface_override_material(0) as StandardMaterial3D).emission = (STONE_WAITING as StandardMaterial3D).emission
...
func _activate_stone(_stone_index: int) -> void:
	...
	var button_mat: StandardMaterial3D = (button.get_surface_override_material(0) as StandardMaterial3D)
